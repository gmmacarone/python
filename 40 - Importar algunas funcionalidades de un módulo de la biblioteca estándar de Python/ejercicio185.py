...
de determinado número natural por todos los números naturales que le anteceden 
excluyendo el cero. Por ejemplo el factorial de 4 es 24, que resulta de multiplicar 4*3*2*1.
...
Solo importar la funcionalidad factorial del módulo math 
...
print("El FACTORIAL de ", valor,"=",resultado)